...
final class ResultScene: SKScene {
    ...
    class func newResultScene(score: Int, bestScore: Int, isNewBest: Bool, stats: GameStats) -> ResultScene {
    ...
    // MARK: - Init
    /// 5개 인자 모두 `let` 이므로 `super.init` 전에 저장.
    ...
    /// 5개 라벨 공통 스타일. TitleScene과 동일 패턴.
