...
enum GameConfig {
    ...
    // MARK: - Account
    static let userProfileUserDefaultsKey: String = "ganho.userProfile.v1"
    static let defaultNickname: String = "간호사"
    static let nicknameMaxLength: Int = 12
    ...
    static let noteSmallVisualScale: CGFloat = 0.72
    static let noteLargeVisualScale: CGFloat = 1.45
    static let noteSmallHitboxSize: CGFloat = 14
    static let noteNormalHitboxSize: CGFloat = 16
    static let noteLargeHitboxSize: CGFloat = 26
    static let noteSmallSpawnChance: CGFloat = 0.24
    static let noteLargeSpawnChance: CGFloat = 0.18
    static let noteLargeCollectHitCount: Int = 3
    static let noteLargeSparkleBurstCount: Int = 3
    static let noteCollectBurstFanOut: CGFloat = 13
    ...
    static let projectileGrazeRewardRadius: CGFloat = 48
    static let projectileGrazeMinimumDistance: CGFloat = 24
    static let projectileGrazeFeedbackCooldown: TimeInterval = 0.18
    static let projectileGrazeToastText: String = "아슬아슬 회피!"
    ...
    static let noteMaxConcurrentByDifficulty: [Difficulty: Int] = [
        .easy: 12, .normal: 14, .hard: 16
    ]
    /// 한 스폰 틱에 보충할 음표 개수. 화면에 항상 "먹을 것"이 남도록 체감 밀도를 만든다.
    static let noteSpawnBatchByDifficulty: [Difficulty: Int] = [
        .easy: 2, .normal: 3, .hard: 3
    ]
    ...
    static let noteLifetimeByDifficulty: [Difficulty: TimeInterval] = [
        .easy: .infinity, .normal: 3.8, .hard: 3.1
    ]
    ...
    static let projectileFireIntervalStartByDifficulty: [Difficulty: TimeInterval] = [
        .easy: 2.0, .normal: 1.45, .hard: 1.15
    ]
    ...
    static let projectileFireIntervalEndByDifficulty: [Difficulty: TimeInterval] = [
        .easy: 1.3, .normal: 0.82, .hard: 0.62
    ]
