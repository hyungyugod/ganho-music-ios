...
//  Phase 7-3 · `.cutscene` case 추가 — 인트로 컷씬 표시 중 모든 시스템 정지 상태 (카운트다운 *전*에 진입)
//
...
enum GameState {
    ...
    case cutscene   // Phase 7-3 — 인트로 컷씬 표시 중. 탭 1회로 .countdown 전환. update의 모든 시스템(스폰/타이머/이동/카메라/적/콤보 폴링) 정지.
